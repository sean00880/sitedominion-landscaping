                     ...
                     <nav>
                        <div className="nav nav-tabs" id="nav-tab" role="tablist">
                           ...
                           <button className="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2"
                              type="button" role="tab" aria-controls="nav-2" aria-selected="false">Live Projects</button>
                           <button className="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3"
                              type="button" role="tab" aria-controls="nav-3" aria-selected="false">Prototype Projects</button>
                        </div>
                     </nav>
                  </div>
               </div>
                            ...
                            <div className="portfolio-wrapper portfolio-slide-wrapper mb-30">
                              ...
                              {portfolioList &&
                                 <div className="swiper-wrapper">
                                    ...
                                    >
                                        {portfolioList.slice(0,2).map((item, num) => (
                                            <SwiperSlide key={num}>
                                                <div className="swiper-slidess">
                                                    <div className="portfolio-single portfolio-bottom-content">
                                                        <div className="portfolio-thumb">
                            ...
                            <div className="portfolio-wrapper portfolio-slide-wrapper mb-30">
                              ...
                              {portfolioList &&
                                 <div className="swiper-wrapper">
                                    ...
                                    >
                                        {portfolioList.slice(2,4).map((item, num) => (
                                            <SwiperSlide key={num}>
                                                <div className="swiper-slidess">
                                                    <div className="portfolio-single portfolio-bottom-content">
                                                        <div className="portfolio-thumb">
